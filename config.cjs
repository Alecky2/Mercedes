...
const config = {
  SESSION_ID: process.env.SESSION_ID || "Ethix-MD&WgZDKubV",
  ...
  OWNER_NAME: process.env.OWNER_NAME || "Alecky",
  OWNER_NUMBER: process.env.OWNER_NUMBER || "254797666750",
  SUDO_NUMBERS: process.env.SUDO_NUMBERS || "254797666750,254742880195",
